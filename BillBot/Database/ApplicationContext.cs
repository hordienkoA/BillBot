...
namespace BillBot.Database
{
    public sealed class ApplicationContext:DbContext
    {
        ...
        {
            optionsBuilder.UseLazyLoadingProxies().UseSqlite("Filename=BillDb");//.UseMySQL("servevsr=localhost;database=botDb;user=;password=Test123");.UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=botdb;Trusted_Connection=True;MultipleActiveResultSets=true");
